...
def get_data(network):
    ...
    '''
    data_dir = f'/Users/ninad/Documents/_CBR/Data/ROI CSV files/{network}_ts/mci'
    data = {}
...
network_CSV_name = ['CB', 'CO', 'DMN', 'FP', 'OP', 'SM']
df = pd.read_csv(f'/Users/ninad/Documents/_CBR/Scripts/Recurrence plots/CSV files/{network_CSV_name[2]}1_mci.csv')
# df = pd.read_csv('/Users/ninad/Documents/_CBR/Scripts/Recurrence plots/second10_mci.csv')
# df = pd.read_csv('/Users/ninad/Documents/_CBR/Scripts/Recurrence plots/third10_mci.csv')
#df = pd.read_csv('/Users/ninad/Documents/_CBR/Scripts/Recurrence plots/last4_mci.csv')

data = get_data(network=network)
roi_req = [i for i in range(1, 11)]
roi_index = [i-1 for i in roi_req]

class_dir = f'/Users/ninad/Documents/_CBR/Data/RP/{network}'
    ...
    for sub_name in data.keys():
        ...
        try:
            ...
            if tau * dim < 170:
                ...
                state_rec_plot(time_data, name=f'{class_dir}/sub_{sub_name[8:-4]}_roi{roi+1}', tau=tau, dim=dim)
                plt.close()
            else:
...
if len(excluded_list)>1:
    file_path = f'mci_excluded{network}.txt'
